...
cloudinary.config(
    cloud_name=os.getenv('CLOUDINARY_CLOUD_NAME', 'dhhvbvxsl'),
    api_key=os.getenv('CLOUDINARY_API_KEY', '275288421299138'),
    api_secret=os.getenv('CLOUDINARY_API_SECRET', 'XWFoqZWD__pHVqXG_EKSROvVoKY')
)
